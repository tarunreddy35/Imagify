...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        <motion.button className=' cursor-pointer sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full'
        ...
        >
            {Array(6).fill('').map((item,index)=>(
                ...
                whileHover={{scale:1.05, duration:0.1}}
                 className='rounded hover:scake-105 transition-all duration-300 cursor-pointer max-sm:w-10'

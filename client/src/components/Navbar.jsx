...
const Navbar = () => {
  ...
  const {user, setShowLogin, logout, credit } = useContext(AppContext); // Assuming user is coming from context or state management
      ...
      <div>
        ...
        <div className='flex items-center gap-2 sm:gap-3'>
          ...
          <div className='relative group'>
            ...
            <div className='absolute hidden group-hover:block top-0 right-o z-10 text-black rounded pt-12'>
